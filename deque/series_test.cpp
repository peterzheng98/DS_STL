...
namespace {
    ...
    TEST(Timer, PushBack) {
        sjtu::deque<int> a;
        for (int i = 0; i < N_SPEED; i++) { a.push_back(rand()); }
    }
    ...
    TEST(Timer, PopBack) {
        ...
        for (int i = 0; i < N_SPEED; i++) { a.pop_back(); }
    }

    TEST(Timer, PushFront) {
        sjtu::deque<int> a;
        for (int i = 0; i < N_SPEED; i++) { a.push_front(rand()); }
    }
    ...
    TEST(Timer, PopFront) {
        ...
        for (int i = 0; i < N_SPEED; i++) { a.pop_front(); }
    }
    ...
    TEST(Timer, Front) {
        ...
        for (int i = 0; i < N_SPEED; i++) { a.front(); }
    }
    ...
    TEST(Timer, Back) {
        ...
        for (int i = 0; i < N_SPEED; i++) { a.back(); }
    }
    ...
    TEST(Timer, Begin) {
        ...
        for (int i = 0; i < N_SPEED; i++) { a.begin(); }
    }
    ...
    TEST(Timer, End) {
        ...
        for (int i = 0; i < N_SPEED; i++) { a.end(); }
    }

    TEST(Timer, IteratorAddOne) {
        sjtu::deque<int> a;
        for (int i = 0; i < N_SPEED; i++) {
            int op = rand() % 3;
            if (op == 0) a.push_back(rand());
        ...
        auto itA = a.begin();
        for (int i = 0; i < N_SPEED; i++) { itA++; }
    }

    TEST(Timer, IteratorRedOne) {
        sjtu::deque<int> a;
        for (int i = 0; i < N_SPEED; i++) {
            int op = rand() % 3;
            if (op == 0) a.push_back(rand());
    ...
    TEST(Timer, IteratorAddN) {
        ...
        auto itA = a.begin();
        for (int i = 0; i < N_SPEED; i++) { itA = a.begin() + i; }
    }

    TEST(Timer, IteratorRedN) {
        sjtu::deque<int> a;
        for (int i = 0; i < N_SPEED; i++) {
            int op = rand() % 3;
            if (op == 0) a.push_back(rand());
        ...
        auto itA = a.end();
        for (int i = 0; i < N_SPEED; i++) { itA = a.end() - i; }
    }

    TEST(Timer, Insert) {
        sjtu::deque<int> a;
        auto itA = a.begin();
        for (int i = 0; i < N_SPEED; i++) { a.insert(a.begin() + rand() % (a.size() + 1), rand()); }
    }
    ...
    TEST(Timer, Erase) {
        ...
        for (int i = 0; i < N_SPEED; i++) { a.erase(a.begin() + (rand() % a.size())); }
    }
    ...
    TEST(Timer, At) {
        ...
        for (int i = 0; i < N_SPEED; i++) { a.at(i) = rand(); }
    }
    ...
    TEST(Timer, Bracket) {
        ...
        for (int i = 0; i < N_SPEED; i++) { a[i] = rand(); }
    }
}